...
prop = hcipy.FraunhoferPropagator(pupil_grid, pl.focal_grid, focal_length=4.0*1.55e-6)
focal_wf = prop(flat_wavefront_pupil)
# %%
pl.coeffs(focal_wf)
# %%
pl.show_lantern_modes(1)
# %%
# if you have lightbeam:
pl.generate_launch_fields()
pl.show_lantern_output(focal_wf)
# %%
